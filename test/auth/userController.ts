...
describe('User Controller', () => {
    ...
    it('should send OTP for password reset successfully', async () => {
        ...
        const userStub = sandbox.stub(User, 'findOne').resolves(new User({
            id: 9,
            email: 'john.doe@example.com',
        }));
    ...
    it('should change password successfully', async () => {
        ...
        const userStub = sandbox.stub(User, 'findByPk').resolves(new User({
            id: 5,
    ...
    it('should handle invalid old password during password change', async () => {
        // Stub User.findByPk to simulate finding a user
        sandbox.stub(User, 'findByPk').resolves(new User({
            id: 4,
    ...
    it('should get list of users successfully', async () => {
        ...
        const findAllStub = sandbox.stub(User, 'findAll');
        findAllStub.resolves([
            new User({ id: 1, firstName: 'User 1', isDeleted: false }),
            new User({ id: 2, firstName: 'User 2', isDeleted: false }),
            new User({ id: 3, firstName: 'User 3', isDeleted: false }),
        ]);
