...
const validateSchema = (schema) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        locale_helper_1.default.setLocale(language);
        try {
            let messages;
...
exports.default = {
    registerUser: (customFields, validate) => {
        const defaultSchema = celebrate_1.Joi.object().keys({
            ...
            password: celebrate_1.Joi.string().pattern(constant_1.passwordRegex)
    ...
    changePw: () => validateSchema(celebrate_1.Joi.object().keys({
        ...
        newPassword: celebrate_1.Joi.string().pattern(constant_1.passwordRegex)
            .message('Password must contain upper, lower, digit, 8+ chars.').required()
    })),
