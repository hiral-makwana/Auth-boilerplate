...
router.post('/changePassword', user_validator_1.default.changePw(), auth_1.verifyToken, userController.changePassword);
/** Check validations */
router.post('/checkValidation', user_validator_1.default.checkValid(), auth_1.verifyToken, userController.checkValidation);
/** Delete user API */
router.delete('/deleteUser/:userId', auth_1.verifyToken, userController.deleteUser);
/** HTML to String */
router.post('/htmlToString', userController.convertHtmlToString);
/** Upload Profile */
router.post('/upload/:userId', auth_1.verifyToken, media_helper_1.upload.single('avatar'), userController.profileUpload);
